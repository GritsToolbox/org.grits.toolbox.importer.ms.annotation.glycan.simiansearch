...
/**
 * NewGelatoHandlerMSProfile
 * @author D. Brent Weatherly
 *
 */
public class NewGelatoHandlerMSProfile {

	//log4J Logger
	private static final Logger logger = Logger.getLogger(NewGelatoHandlerMSProfile.class);
	
	public static AnalyteStructureAnnotation getNewStructureAnnotationObject(Data data, String t_tempFolder, String msAnnotationFolder, 
			MSGlycanAnnotationProperty t_property, MSFile msFile) {
		try {
			return new GlycanStructureAnnotationMSProfile(data, t_tempFolder, 
